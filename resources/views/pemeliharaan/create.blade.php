<x-app-layout>
  <x-slot name="header">
    {{ __('Tambah Pemeliharaan') }}
  </x-slot>

  <div class="p-4 bg-white rounded-lg shadow-xs">
    <h1 class="text-2xl font-semibold text-gray-800">Tambah Pemeliharaan</h1>

    <div class="overflow-hidden mb-8 w-full rounded-lg shadow-xs">
      <div class="overflow-x-auto w-full">
        <form action="{{ route('pemeliharaan.store') }}" method="POST" autocomplete="off">
          @csrf
          ...
          <div class="mt-4">
            ...
            <x-text-input type="date" id="tanggal" name="tanggal" class="block w-full" value="{{ old('tanggal') }}"
              required />
