<x-app-layout>
  ...
  <div class="p-4 bg-white rounded-lg shadow-xs">
    <h1 class="text-2xl font-semibold text-gray-800">Tambah Lahan</h1>

    <div class="overflow-hidden mb-8 w-full rounded-lg shadow-xs">
      <div class="overflow-x-auto w-full">
        <form action="{{ route('lahan.store') }}" method="POST" autocomplete="off">
          @csrf
          ...
          <div class="mt-4">
            ...
            <x-text-input type="text" id="lokasi_lahan" name="lokasi_lahan" class="block w-full"
              value="{{ old('lokasi_lahan') }}" required />
