<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
    <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('panen.index') }}" :active="request()->routeIs('panen.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
            ...
            <li class="relative px-6 py-3">
                ...
                <span class="inline-flex items-center">
                    ...
                    <span class="ml-4">Report Menu</span>
                </span>
                ...
                <template x-if="isMultiLevelMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportBagian') }}">Report Bagian</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportJabatan') }}">Report Jabatan</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportPegawai') }}">Report Pegawai</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportPelatihan') }}">Report Pelatihan</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportLahan') }}">Report Lahan</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportTanaman') }}">Report Tanaman</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportPemeliharaan') }}">Report Pemeliharaan</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a class="w-full" target="_blank" href="{{ route('reportPanen') }}">Report Panen</a>
                        </li>
                    </ul>
                </template>
            </li>
